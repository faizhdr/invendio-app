                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Kondisi Barang <span class="badge badge-sm bg-gradient-success">Baik</span></p>
                                    <h3 class="font-weight-bolder">
                                        {{ $kondisi1 }}
                                    </h3>
                                </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Kondisi Barang <span class="badge badge-sm bg-gradient-warning">Kurang Baik</span></p>
                                    <h3 class="font-weight-bolder">
                                        {{ $kondisi2 }}
                                    </h3>
                                </div>
