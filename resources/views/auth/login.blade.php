                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('https://thumbs.dreamstime.com/b/pile-de-cartons-36466100.jpg');
              background-size: cover;">
                                <span class="mask bg-gradient-primary opacity-6"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Persediaan dari sebuah bisnis"</h4>
                                <p class="text-white position-relative">Aplikasi yang berkaitan dengan persediaan barang-barang di gudang.</p>
                            </div>
                        </div>
                    </div>
                </div>
